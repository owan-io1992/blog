...
- k8s-reading
---
# Concepts - scheduling-eviction - Taints and Tolerations
...
在 Kubernetes (K8s) 的世界裡，調度 (Scheduling) 是一個核心議題。我們之前介紹過的 [Node Affinity](/docs/k8s-doc-reading/k8s-doc-reading-assign_pod_to_node/) 是一種「吸引」機制，讓 Pod 可以**選擇**被調度到特定的 Node 上。
