...
**Secret** 是 Kubernetes (K8s) 中用來儲存少量敏感資訊的物件，例如密碼、OAuth 權杖或 SSH 金鑰。在使用上，它與 [ConfigMap](/docs/k8s-doc-reading/k8s-doc-reading-configuration-configmaps/) 非常相似，可以透過環境變數或掛載成檔案的方式注入到 Pod 中。
