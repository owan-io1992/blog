...
1. 利用之前的 vagrant 起 4 個 node [vagrant-introduction](/blog/2025/06/12/_vagrant-introduction)  
2. 設定 [keepalived](/docs/k3s/k3s-install-advance-1/#1-%E5%AE%89%E8%A3%9D-keepalived)   
